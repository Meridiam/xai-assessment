...
from tau2.domains.xai_domain.environment import (
    get_environment_manual_policy as xai_domain_get_environment_manual_policy,
)
from tau2.domains.xai_domain.environment import (
    get_environment_workflow_policy as xai_domain_get_environment_workflow_policy,
)
from tau2.domains.xai_domain.environment import get_tasks as xai_domain_get_tasks
from tau2.domains.xai_domain.environment import (
    get_tasks_full as xai_domain_get_tasks_full,
)
from tau2.domains.xai_domain.environment import (
    get_tasks_small as xai_domain_get_tasks_small,
)
...
try:
    ...
    registry.register_domain(xai_domain_get_environment_manual_policy, "xai_domain")
    registry.register_domain(
        xai_domain_get_environment_workflow_policy, "xai_domain-workflow"
    )
    registry.register_tasks(xai_domain_get_tasks_full, "xai_domain_full")
    registry.register_tasks(xai_domain_get_tasks_small, "xai_domain_small")
    registry.register_tasks(xai_domain_get_tasks, "xai_domain")
    registry.register_tasks(xai_domain_get_tasks, "xai_domain-workflow")
    logger.debug(
