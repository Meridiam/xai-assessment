...
from tau2.domains.xai_domain.tasks.mms_issues import mms_issue_task_manager
from tau2.domains.xai_domain.tasks.mobile_data_issues import mobile_data_task_manager
from tau2.domains.xai_domain.tasks.service_issues import service_issues_task_manager
from tau2.domains.xai_domain.tasks.utils import get_persona_from_task_id
...
def create_tasks(save_tasks: bool = True, max_count_per_bin: int = 3) -> list[Task]:
    ...
    file = DATA_DIR / "tau2" / "domains" / "xai_domain" / f"tasks_full.json"
    if save_tasks:
    ...
    file_small = DATA_DIR / "tau2" / "domains" / "xai_domain" / f"tasks_small.json"
    ...
    file_sampled = DATA_DIR / "tau2" / "domains" / "xai_domain" / f"tasks.json"
