...
from tau2.domains.xai_domain.data_model import (
    Bill,
    BillStatus,
    Customer,
    Device,
...
from tau2.domains.xai_domain.utils import get_today
...
class XaiDomainTools(ToolKitBase):
    """Tools for the xai domain implementing the functions described in the PRD."""

    db: XaiDomainDB

    def __init__(self, db: XaiDomainDB) -> None:
