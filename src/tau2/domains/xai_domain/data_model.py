...
from tau2.domains.xai_domain.utils import XAI_DOMAIN_DB_PATH
...
class XaiDomainDB(DB):
    """Database interface for xai domain."""
...
def get_db():
    """Get an instance of the xai domain database."""
    return XaiDomainDB.load(XAI_DOMAIN_DB_PATH)
